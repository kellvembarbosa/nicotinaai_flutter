...
class RevenueCatPurchaseController extends PurchaseController {
  ...
  Future<void> configureAndSyncSubscriptionStatus() async {
    ...
    Purchases.addCustomerInfoUpdateListener((customerInfo) async {
      ...
      final hasActiveEntitlementOrSubscription =
          customerInfo.hasActiveEntitlementOrSubscription(); // Why? -> https://www.revenuecat.com/docs/entitlements#entitlements
  ...
  Future<SubscriptionOption?> _fetchGooglePlaySubscriptionOption(StoreProduct storeProduct, String? basePlanId, String? offerId) async {
