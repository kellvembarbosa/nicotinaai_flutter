...
class FacebookTrackingAdapter implements TrackingAdapter {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (Platform.isIOS) {
        ...
        debugPrint('🔍 [FacebookTracking] iOS Tracking Authorization Status: $status');
  ...
  Future<void> trackEvent(String eventName, {Map<String, dynamic>? parameters}) async {
    ...
    if (!_isTrackingEnabled) {
      debugPrint('⚠️ [FacebookTracking] Tracking disabled, event not logged: $eventName');
      return;
    }
    ...
    try {
      ...
      if (_hasTrackingPermission || !Platform.isIOS) {
        ...
        debugPrint('📊 [FacebookTracking] Logged event: $eventName with parameters: $parameters');
      } else {
        debugPrint('⚠️ [FacebookTracking] Tracking not authorized, event not logged: $eventName');
      }
    } catch (e) {
  ...
  Future<void> setUserProperties(Map<String, dynamic> properties) async {
    ...
    if (!_isTrackingEnabled) {
      debugPrint('⚠️ [FacebookTracking] Tracking disabled, user properties not set');
      return;
    }
  ...
  set isTrackingEnabled(bool value) {
    ...
    debugPrint('🔄 [FacebookTracking] Tracking ${value ? 'enabled' : 'disabled'}');
  }
}
