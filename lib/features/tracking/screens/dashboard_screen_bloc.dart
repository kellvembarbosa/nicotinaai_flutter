...
/// Dashboard screen using BLoC pattern instead of Provider
class DashboardScreenBloc extends StatelessWidget {
  const DashboardScreenBloc({Key? key}) : super(key: key);
...
class _DashboardScreenContent extends StatelessWidget {
  ...
  Widget _buildMoneySavedCard(BuildContext context, UserStats userStats, bool isLoading) {
    final l10n = AppLocalizations.of(context)!;
