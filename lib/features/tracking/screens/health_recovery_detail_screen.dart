...
class HealthRecoveryDetailScreen extends StatefulWidget {
  ...
  const HealthRecoveryDetailScreen({
    Key? key,
...
class _HealthRecoveryDetailScreenState extends State<HealthRecoveryDetailScreen> {
  ...
  Widget _buildProgressSection(HealthRecovery recovery, bool isAchieved) {
    ...
    final daysRemaining = isAchieved
        ? 0
        : (daysToAchieve - _currentStreakDays) > 0 ? (daysToAchieve - _currentStreakDays) : 0;
        ...
        Row(
          ...
          children: [
            Text(
              isAchieved
                  ? l10n.achieved
                  : l10n.daysSmokeFree(_currentStreakDays),
              ...
              ? Center(
                  child: Column(
                    ...
                    children: [
                      ...
                      TextButton(
                        onPressed: _loadRecoveryDetails,
