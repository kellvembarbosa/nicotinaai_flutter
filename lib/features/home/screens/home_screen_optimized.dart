...
class _HomeScreenState extends State<HomeScreen> {
          ...
          return MultiBlocListener(
            ...
            child: BlocBuilder<TrackingBloc, TrackingState>(
              builder: (context, trackingState) {
                ...
                bool isLoading = trackingState.isStatsLoading || trackingState.isLogsLoading || _isUpdating;
  ...
  Widget _buildStatisticCard(BuildContext context, String value, String label, Color color, IconData icon, bool isLoading) {
    // Não precisamos verificar novamente o isLoading pois já recebemos como parâmetro
    return Container(
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              if (_daysWithoutSmoking > 0 && !isLoading) ...[  // Só mostrar quando não estiver carregando
                const Icon(
                  Icons.arrow_upward,
                  color: Colors.green,
                  size: 16,
