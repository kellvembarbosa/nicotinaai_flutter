...
class _RegisterCravingSheetState extends State<RegisterCravingSheet> {
  ...
  Widget build(BuildContext context) {
    ...
    return DraggableScrollableSheet(
      ...
      builder: (context, scrollController) {
        return Container(
          decoration: BoxDecoration(color: context.backgroundColor, borderRadius: const BorderRadius.vertical(top: Radius.circular(24))),
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: context.isDarkMode ? context.primaryColor.withOpacity(0.15) : context.primaryColor.withOpacity(0.08),
                      ...
                      child: Column(
                        children: [
                          Text(
                            ...
                            style: context.titleStyle.copyWith(fontSize: 20, fontWeight: FontWeight.bold, color: context.primaryColor),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: context.isDarkMode ? Colors.grey[850]!.withOpacity(0.8) : Colors.white,
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.03), blurRadius: 10, offset: const Offset(0, 2))],
                        border: _selectedLocation != null ? Border.all(color: context.primaryColor.withOpacity(0.3), width: 1.5) : null,
                      ),
                      child: Column(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.place_outlined, size: 18, color: context.primaryColor),
                                  ...
                                  if (_selectedLocation != null)
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          Icon(_getLocationIcon(_selectedLocation!), size: 14, color: context.primaryColor),
                          ...
                          // Conteúdo expansível
                          if (_isLocationSectionExpanded) Padding(padding: const EdgeInsets.all(16), child: _buildLocationGrid(context, l10n)),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.03), blurRadius: 10, offset: const Offset(0, 2))],
                        border: _selectedTrigger != null ? Border.all(color: context.primaryColor.withOpacity(0.3), width: 1.5) : null,
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.psychology_outlined, size: 18, color: context.primaryColor),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: Text(
                                  ...
                                  const SizedBox(width: 4),
                                  Icon(_isTriggerSectionExpanded ? Icons.expand_less : Icons.expand_more, color: Colors.grey),
                                ],
                              ),
                            ),
                          ),
                          ...
                          // Conteúdo expansível
                          if (_isTriggerSectionExpanded) Padding(padding: const EdgeInsets.all(16), child: _buildTriggerOptions(context, l10n)),
                        ],
                      ),
                    ),
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            _selectedIntensity != null
                                ? Border.all(color: _getIntensityColor(_selectedIntensity!).withOpacity(0.3), width: 1.5)
                                : null,
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.speed_outlined, size: 18, color: context.primaryColor),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: Text(
                                      l10n.intensityLevel,
                                  ...
                                  if (_selectedIntensity != null)
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.circular(12),
                                        border: Border.all(color: _getIntensityColor(_selectedIntensity!).withOpacity(0.3)),
                                      ),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Icon(_getIntensityIcon(_selectedIntensity!), size: 14, color: _getIntensityColor(_selectedIntensity!)),
                                          const SizedBox(width: 4),
                                          Text(
                          ...
                          // Conteúdo expansível
                          if (_isIntensitySectionExpanded) Padding(padding: const EdgeInsets.all(16), child: _buildIntensityOptions(context, l10n)),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        border:
                            _didResist != null
                                ? Border.all(color: _didResist! ? Colors.green.withOpacity(0.3) : Colors.redAccent.withOpacity(0.3), width: 1.5)
                                : null,
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.fitness_center_outlined, size: 18, color: context.primaryColor),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: Text(
                                      l10n.didYouResist,
                                  ...
                                  if (_didResist != null)
                                    Container(
                                      padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
                                      decoration: BoxDecoration(
                                        color: _didResist! ? Colors.green.withOpacity(0.1) : Colors.redAccent.withOpacity(0.1),
                                        borderRadius: BorderRadius.circular(12),
                                        border: Border.all(color: _didResist! ? Colors.green.withOpacity(0.3) : Colors.redAccent.withOpacity(0.3)),
                                      ),
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
                                          Icon(
                                            _didResist! ? Icons.check_circle_outline : Icons.cancel_outlined,
                                            size: 14,
                          ...
                          // Conteúdo expansível
                          if (_isResistSectionExpanded) Padding(padding: const EdgeInsets.all(16), child: _buildResistOptions(context, l10n)),
                        ],
                      ),
                    ),
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(16),
                        boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.03), blurRadius: 10, offset: const Offset(0, 2))],
                        border: _notesController.text.isNotEmpty ? Border.all(color: context.primaryColor.withOpacity(0.3), width: 1.5) : null,
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(
                                children: [
                                  Icon(Icons.note_outlined, size: 18, color: context.primaryColor),
                                  const SizedBox(width: 8),
                                  Expanded(
                                    child: Text(l10n.notes, style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold, color: context.primaryColor)),
                                  ),
                                  if (_notesController.text.isNotEmpty)
                                    Container(
                                      ...
                                      child: Text(
                                        _notesController.text.length > 15 ? "${_notesController.text.substring(0, 15)}..." : _notesController.text,
                                        style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold, color: context.primaryColor),
                                        overflow: TextOverflow.ellipsis,
                                      ),
                                    ),
                          ...
                          // Conteúdo expansível
                          if (_isNotesSectionExpanded) Padding(padding: const EdgeInsets.all(16), child: _buildNotesField(context, l10n)),
                        ],
                      ),
                    ),
              ...
              Container(
                width: double.infinity,
                padding: EdgeInsets.only(left: 20, right: 20, bottom: 16 + MediaQuery.of(context).padding.bottom, top: 8),
                decoration: BoxDecoration(
                  color: context.backgroundColor,
                  boxShadow: [BoxShadow(color: Colors.black.withOpacity(0.07), offset: const Offset(0, -3), blurRadius: 8)],
                ),
                child: Column(
                  mainAxisSize: MainAxisSize.min,
                                    ...
                                    SnackBar(
                                      content: Column(
                                        ...
                                        children: [
                                          ...
                                          if (tipMessage.isNotEmpty) Text(tipMessage, style: const TextStyle(fontSize: 12)),
                                        ],
                                      ),
                        ...
                        child: Ink(
                          decoration: BoxDecoration(
                            gradient: LinearGradient(
                              colors: [context.primaryColor, context.primaryColor.withRed((context.primaryColor.red + 25).clamp(0, 255))],
  ...
  bool _isFormValid() {
    return _selectedLocation != null && _selectedTrigger != null && _selectedIntensity != null && _didResist != null;
  }
  ...
  Widget _buildLocationGrid(BuildContext context, AppLocalizations l10n) {
    final locations = [
      ...
      _LocationOption(icon: Icons.directions_car, label: l10n.car, value: 'car'),
      ...
      _LocationOption(icon: Icons.map, label: l10n.street, value: 'street'),
      _LocationOption(icon: Icons.park, label: l10n.park, value: 'park'),
      _LocationOption(icon: Icons.more_horiz, label: l10n.others, value: 'others'),
    ];
  ...
  Widget _buildIntensityOptions(BuildContext context, AppLocalizations l10n) {
    ...
    return GridView.builder(
      shrinkWrap: true,
      physics: const NeverScrollableScrollPhysics(),
      gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 4, childAspectRatio: 1.0, crossAxisSpacing: 10, mainAxisSpacing: 0),
      itemCount: intensities.length,
      itemBuilder: (context, index) {
        final intensity = intensities[index];
        return _buildIntensityOption(context, intensity.label, intensity.value);
      },
    );
  }
  ...
  Widget _buildSelectionChip(BuildContext context, String label, String value, {required bool isSelected, required Function(bool) onSelected}) {
    return FilterChip(
      label: Text(label),
      selected: isSelected,
      ...
      backgroundColor: context.isDarkMode ? Colors.grey.withAlpha(26) : Colors.grey.withAlpha(13),
      selectedColor: context.primaryColor.withAlpha(51),
      checkmarkColor: context.primaryColor,
      shape: RoundedRectangleBorder(
        borderRadius: BorderRadius.circular(16),
        side: BorderSide(color: isSelected ? context.primaryColor : Colors.transparent),
      ),
  ...
  Widget _buildIntensityOption(BuildContext context, String label, String value) {
        ...
        decoration: BoxDecoration(
          color:
              isSelected
                  ...
                  : Colors.grey.withOpacity(0.05),
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: isSelected ? itemColor : Colors.transparent, width: 1.5),
        ),
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(shape: BoxShape.circle, color: isSelected ? itemColor.withOpacity(0.2) : Colors.transparent),
              child: Icon(iconData, color: isSelected ? itemColor : Colors.grey, size: iconSize),
            ),
            const SizedBox(height: 4),
            // Texto descritivo
            FittedBox(
  ...
  Widget _buildNotesField(BuildContext context, AppLocalizations l10n) {
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: context.isDarkMode ? Colors.grey.withOpacity(0.2) : Colors.grey.withOpacity(0.15), width: 1.0),
      ),
      child: TextField(
        controller: _notesController,
        maxLines: isSmallScreen ? 2 : 3,
        minLines: isSmallScreen ? 1 : 2,
        style: TextStyle(fontSize: 15, color: context.contentColor),
        onChanged: (text) {
        ...
        decoration: InputDecoration(
          ...
          hintStyle: TextStyle(color: context.subtitleColor, fontSize: 14, fontStyle: FontStyle.italic),
          prefixIcon: Padding(
            padding: const EdgeInsets.symmetric(horizontal: 12.0),
            child: Icon(Icons.edit_note_outlined, color: context.primaryColor.withOpacity(0.5), size: 20),
          ),
          contentPadding: const EdgeInsets.all(16),
          border: InputBorder.none,
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(16),
            borderSide: BorderSide(color: context.primaryColor.withOpacity(0.5), width: 1.5),
          ),
        ),
      ),
    );
    ...
    return Row(
      ...
      children: [
        SizedBox(
          ...
          child: _buildResistOption(context, l10n.yes, true, Colors.green),
        ),
        const SizedBox(width: 16), // Espaçamento entre os botões
        SizedBox(
          width: MediaQuery.of(context).size.width * 0.38, // 38% da largura da tela
          height: 60, // Altura fixa para melhor toque
          child: _buildResistOption(context, l10n.no, false, Colors.redAccent),
        ),
      ],
    );
  }

  Widget _buildResistOption(BuildContext context, String label, bool value, Color color) {
        ...
        decoration: BoxDecoration(
          ...
          color:
              isSelected
                  ...
                  : Colors.grey.withOpacity(0.05),
          borderRadius: BorderRadius.circular(16),
          boxShadow: isSelected ? [BoxShadow(color: color.withOpacity(0.3), blurRadius: 10, offset: const Offset(0, 3))] : null,
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(getIcon(), color: isSelected ? Colors.white : color.withOpacity(0.7), size: iconSize),
            const SizedBox(width: 8),
            Text(
              label,
              style: TextStyle(fontSize: fontSize, fontWeight: FontWeight.bold, color: isSelected ? Colors.white : context.contentColor),
              textAlign: TextAlign.center,
            ),
          ],
        ),
...
class _TriggerOption {
  ...
  const _TriggerOption({required this.label, required this.value});
}
